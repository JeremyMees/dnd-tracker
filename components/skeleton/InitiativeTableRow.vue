<template>
  <UiTableRow>
    <UiTableCell class="max-w-20 p-2">
    ...
    <UiTableCell class="p-2">
      <div class="flex gap-2">
        <UiSkeleton class="size-5 rounded-lg" />
        <UiSkeleton class="w-[160px] h-5 rounded-full" />
      </div>
    </UiTableCell>
    <UiTableCell class="p-2">
      <UiSkeleton class="size-5 rounded-lg" />
    ...
    <UiTableCell class="p-2">
      <UiSkeleton class="h-10 min-w-[150px] rounded-lg" />
    </UiTableCell>
    <UiTableCell class="p-2">
      <div class="grid gap-1 w-fit mx-auto">
        <div class="grid grid-cols-3 gap-1 w-14">
