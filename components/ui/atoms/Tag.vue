...
<template>
  <div
    ...
    :class="{
      ...
      'bg-slate-700/50 border-slate-700': color === 'slate',
      ...
      <template #content>
        <div class="p-4 space-y-2 overflow-auto">
          ...
          <div v-if="condition.hasLevels">
            ...
            <div class="w-fit flex gap-2 items-center bg-slate-700/50 rounded-lg border-2 border-slate-700">
              <button
                :disabled="amount <= 1"
                class="disabled:opacity-40 disabled:cursor-not-allowed duration-300 ease-in-out py-1 pl-1 pr-2 border-r-2 border-slate-700 flex flex-col items-center"
                @click="amount--"
              >
                <Icon
              ...
              <button
                :disabled="amount >= 6"
                class="disabled:cursor-not-allowed disabled:opacity-40 py-1 pl-2 pr-1 border-l-2 border-slate-700 flex flex-col items-center"
                @click="amount++"
              >
                <Icon
