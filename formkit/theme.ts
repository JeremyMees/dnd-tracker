export default {
  'global': {
    fieldset: 'border-4 border-background rounded-lg px-2 pb-1 bg-muted',
    ...
    input: 'outline-none text-foreground bg-muted disabled:cursor-not-allowed placeholder:text-muted-foreground',
    legend: 'block mb-1 font-bold text-sm',
    loaderIcon: 'inline-flex items-center w-4 text-muted-foreground animate-spin',
    label: 'block mb-1 font-bold text-sm',
    messages: 'list-none p-0 mt-1 mb-0',
    message: 'text-destructive text-xs mt-1',
  ...
  'family:dropdown': {
    ...
    emptyMessageInner: 'flex items-center justify-center text-sm p-2 text-center w-full text-muted-foreground [&>span]:mr-3 [&>span]:ml-0',
    inner: 'relative flex border-4 border-background focus-within:border-primary rounded-lg mb-1',
    input: 'w-full px-3 py-2 rounded overflow-hidden border-none outline-none',
    listbox: 'bg-muted border-4 border-background rounded-lg overflow-hidden backdrop-blur',
    listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
    listitem: 'pl-5 text-sm cursor-pointer relative data-[is-active="true"]:text-primary data-[is-active="true"]:aria-selected:text-primary aria-selected:text-primary aria-selected:text-primary',
    loaderIcon: 'ml-auto',
    loadMoreInner: 'flex items-center justify-center text-sm p-2 text-center w-full text-blue-500 formkit-loading:text-muted-foreground cursor-pointer [&>span]:mr-3 [&>span]:ml-0',
    option: 'p-2.5',
    optionLoading: 'text-muted-foreground',
    placeholder: 'p-2.5 text-muted-foreground',
  ...
  'family:text': {
    inner: 'bg-muted flex items-center border-4 border-background focus-within:border-primary rounded-lg',
    input: 'bg-transparent w-full px-3 py-2 border-none placeholder:text-muted-foreground',
  },
  'radio': {
  ...
  'select': {
    inner: 'flex relative items-center rounded-lg mb-1 border-4 border-background focus-within:border-primary',
    input: 'w-full px-3 py-2 h-10 rounded border-none placeholder:text-muted-foreground formkit-multiple:p-0 data-[placeholder="true"]:text-muted-foreground formkit-multiple:data-[placeholder="true"]:text-inherit',
    selectIcon: 'flex p-[3px] shrink-0 w-5 mr-2 -ml-[1.5em] h-full pointer-events-none [&>svg]:w-[1em]',
    option: 'bg-muted text-foreground formkit-multiple:p-3 formkit-multiple:text-sm',
    icon: 'hidden',
  },
  'textarea': {
    inner: 'flex rounded-lg mb-1 border-4 border-background focus-within:border-primary',
    input: 'block w-full min-h-[40px] h-32 px-3 py-3 border-none text-base placeholder:text-muted-foreground',
  },
  'autocomplete': {
    closeIcon: 'block grow-0 shrink-0 w-3 mr-3.5',
    inner: '[&>div>[data-value]]:absolute [&>div>[data-value]]:mb-0',
    option: 'grow text-ellipsis',
    selection: 'static flex left-0 top-0 right-0 bottom-0 mt-0 mb-2 rounded-lg bg-muted-foreground',
  },
  'repeater': {
    ...
    removeControl: 'hover:text-destructive disabled:hover:text-inherit disabled:opacity-25 px-2 transition-colors duration-200',
  ...
  'file': {
    fileItem: 'flex items-center text-foreground mb-1 last:mb-0',
    ...
    fileRemove:
      'relative z-[2] ml-auto text-[0px] hover:text-destructive pl-2 peer-data-[has-multiple=true]:text-sm peer-data-[has-multiple=true]:text-primary peer-data-[has-multiple=true]:ml-3 peer-data-[has-multiple=true]:mb-2 formkit-multiple:bottom-[0.15em] formkit-multiple:pl-0 formkit-multiple:ml-0 formkit-multiple:left-[1em] formkit-multiple:formkit-prefix-icon:left-[3.75em]',
    fileRemoveIcon: 'block text-base w-3 relative z-[2]',
    inner:
      'relative cursor-pointer formkit-multiple:[&>button]:absolute bg-muted',
    input:
      'cursor-pointer text-transparent absolute top-0 right-0 left-0 bottom-0 opacity-0 z-[2]',
    noFiles: 'flex w-full items-center px-3 py-2 text-muted-foreground',
  ...
  'toggle': {
    ...
    thumb: 'relative left-0 aspect-square rounded-full transition-all w-5 bg-muted-foreground',
    track: 'cursor-pointer p-0.5 min-w-[3em] relative rounded-full border-2 border-background transition-all bg-muted peer-checked:bg-foreground peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
    valueLabel: 'font-bold text-sm',
    wrapper: 'flex flex-wrap items-center mb-1 disabled:!cursor-not-allowed disabled:!opacity-50',
    label: '$reset !mb-0 cursor-pointer text-sm font-bold',
  },
  'togglebuttons': {
