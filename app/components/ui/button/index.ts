  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        'default-ghost': 'hover:bg-primary hover:text-primary-foreground',
        secondary:
          'border-4 bg-secondary/50 hover:bg-secondary/60 border-secondary text-foreground shadow-sm',
        'secondary-ghost': 'hover:bg-secondary hover:text-secondary-foreground',
        tertiary:
          'border-4 bg-tertiary/50 hover:bg-tertiary/60 border-tertiary text-foreground shadow-sm',
        'tertiary-ghost': 'hover:bg-tertiary hover:text-tertiary-foreground',
        destructive:
        ...
        'success-ghost': 'hover:bg-success hover:text-success-foreground',
        warning:
          'border-4 bg-warning/50 hover:bg-warning/60 border-warning text-foreground shadow-sm',
        'warning-ghost': 'hover:bg-warning hover:text-warning-foreground',
        info: 'border-4 bg-info/50 hover:bg-info/60 border-info text-foreground shadow-sm',
        'info-ghost': 'hover:bg-info hover:text-info-foreground',
        help: 'border-4 bg-help/50 hover:bg-help/60 border-help text-foreground shadow-sm',
        'help-ghost': 'hover:bg-help hover:text-help-foreground',
        foreground:
          'border-4 bg-foreground/50 hover:bg-foreground/60 border-foreground text-background shadow-sm',
        'foreground-ghost': 'hover:bg-foreground hover:text-background',
        background:
          'border-4 bg-background/50 hover:bg-background/60 border-background text-foreground shadow-sm',
        'background-ghost': 'hover:bg-background hover:text-foreground',
